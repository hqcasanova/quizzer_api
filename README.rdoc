...
Final MVP for Bitmaker's course consisting of a real-time classroom quiz application based on Angular.js (v1.2.25), Ruby on Rails and Firebase. It can be tested [here](https://rt-quizzer.herokuapp.com).
